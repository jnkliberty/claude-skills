...
## Result Skeletons — the 20-40 word floor

One clear result, minimal setup, direct ask. No context, no credentials, no second paragraph explaining yourself. Use when the offer is strong enough to stand alone — and it should be, if it passed the Offer Gate in SKILL.md.

**S1 — Risk reversal:**

> Hey {{FirstName}}, if I could get you {result} without {risk}, {CTA}?

**S2 — Vague-to-specific:**

> Hey {{FirstName}}, could you handle {vague result}? I might be able to get you {specific result}.

**S3 — Permissioned:**

> Hey {{FirstName}}, not sure if you have the need for it, but I could get you {result}. {CTA}?

**Give-first (the mafia offer):** lead with a deliverable the reader can use whether or not they ever reply, and ask only whether they want it. The deliverable arrives in the reply, not after a call.

> Hey {{FirstName}}, I put together a one-page teardown of where {company}'s {workflow} is quietly costing hours — built from public data. Want it? Yours either way.
